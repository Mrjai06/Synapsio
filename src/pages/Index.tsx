  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <main className="relative" style={{ zIndex: 1 }}>
        ...
        {/* Act 2: Market Opportunity — why this matters now */}
        <section id="opportunity" className="relative">
          <OpportunitySection />
        </section>

        {/* Act 3: The Challenge - Friction Emerges */}
        <section id="problem" className="relative">
          <ProblemSection />
        </section>

        {/* Act 4: The Solution - Order Restored */}
        <section id="solution" className="relative">
          <SolutionSection />
        </section>

        {/* Act 5: Our Product - Process Overview + Features + Comparison */}
        ...
        {/* Act 7: The Team - Human Trust + Close */}
