    ...
    <section ref={sectionRef} className="relative min-h-[110vh] overflow-hidden" style={{ zIndex: 2 }}>
      ...
      <div className="absolute top-0 left-0 right-0 z-10 px-4 lg:px-8 pt-36 flex flex-col items-center text-center gap-6 transition-all duration-700" style={{
        ...
        <p className="text-lg md:text-xl max-w-xl font-light leading-[1.7] animate-fade-in text-primary/70 text-center" style={{
          animationDelay: "0.6s",
          animationDuration: "1.4s"
        }}>AI-native supply chain management — from reordering to supplier negotiation, fully automated.</p>
      </div>

      {/* BOTTOM: CTA centered */}
      <div className="absolute bottom-0 left-0 right-0 z-10 px-8 pb-48 md:pb-80 flex flex-col items-center gap-6 transition-all duration-700" style={{
        opacity: Math.max(0, contentOpacity),
        transform: `translateY(${contentTranslate}px)`
      }}>
        ...
        <div className="animate-fade-in flex flex-col sm:flex-row items-center gap-4" style={{
          ...
          <FloatingSurface elevation="high" glow glowColor="primary" className="rounded-full">
            <a href="https://app.synapsio.solutions" target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="group bg-primary text-primary-foreground hover:bg-primary/90 rounded-full px-10 py-6 text-sm tracking-wide font-normal transition-all duration-1000 hover:scale-[1.02]">
                Try the app
          ...
          <FloatingSurface elevation="low" className="rounded-full">
            <a href="/Synapsio_Pitch.pdf" target="_blank" rel="noopener noreferrer">
              <Button size="lg" variant="outline" className="group rounded-full px-10 py-6 text-sm tracking-wide font-normal border-primary/30 text-primary/80 hover:border-primary/60 hover:text-primary transition-all duration-1000 hover:scale-[1.02]">
                View Pitchdeck
                <ArrowRight className="ml-3 h-4 w-4 transition-transform duration-700 group-hover:translate-x-1" />
              </Button>
            </a>
