...
import {
  ...
  TrendingDown, Zap, Users, Circle, Play, CheckCircle, Plus, X } from
"lucide-react";
                  ...
                  <motion.div
                    ...
                    <motion.div
                      ...
                      <div className="ml-auto shrink-0">
                        ...
                        <Plus className="w-4 h-4 text-muted-foreground/40 bg-secondary-foreground" />
                        }
                        </div>
                      }
                    </motion.div>
...
}: {state: SystemState;onStateClick: (state: SystemState) => void;isPaused: boolean;}) => {
...
}: {semantics: {input: string;decision: string;action: string;};state: SystemState;}) => {
  const steps = [
